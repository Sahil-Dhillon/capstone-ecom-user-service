...
public class JwtService {
    ...
    public String generateToken(com.ecom.model.user.UserDetails userDetails) {
        return generateToken(new HashMap<>(), userDetails);
    }

    public String generateToken(Map<String, Object> extraClaims, com.ecom.model.user.UserDetails userDetails) {
//    	extraClaims.put("role", userDetails.getAuthorities());
    ...
    private String buildToken(
            ...
            com.ecom.model.user.UserDetails userDetails,
            long expiration
    ) {
        return Jwts
                .builder()
